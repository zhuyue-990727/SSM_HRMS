...
<body><img width="100%" height="100%" src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=2090090414,3038344648&fm=26&gp=0.jpg" style="position:absolute; left:0; top:0; z-index:-1;"/>
<div class="container">
    <div class="row">
                ...
                <div class="panel-body">
                    <form role="form" action="#" method="post" id="login_form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="密码:123456" name="password" type="password" value="">
                            </div>
